        ...
        <!-- Content -->
          ...
          <div class="row">
                <div class="col-12">
                    ...
                    <form method="POST" action="phpscripts/order.php" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <!-- 1. Delivery Address -->
                            <h5 class="mb-4">Rashan Details</h5>
                            <?php
                                ...
                                $customerquery="SELECT * from rd_people where cnic=$donationid";
                            ...
                            <?php 
                                ...
                                $imgsource=$getdata['photo'];
                                if($imgsource!=NULL){
                                    echo '<img src="assets/customerphotos/'.$imgsource.'"  width="90" height="90"  class="rounded" />';
                                    }
                            ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="fullname" name="name" value="<?php echo $getdata['name'] ?>" class="form-control"  required disabled/>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="fullname">Father Name</label>
                                <input type="text" id="fullname" name="fname" value="<?php echo $getdata['fname'] ?>" class="form-control"  required disabled/>
                               
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="fullname">Gender</label>
                                <input type="text" id="fullname" name="gender" value="<?php echo $getdata['gender'] ?>" class="form-control"  required disabled/>
                            </div>
                         
                            <div class="col-md-6">
                                <label class="form-label" for="CNIC">CNIC/Passport </label>
                                <input type="text" id="CNIC" name="cnic" maxlength="13" value="<?php echo $getdata['cnic'] ?>"  class="form-control"  required disabled/>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="city">Products</label><br>
                            
                                <br>
                                <table class="table">
                                <?php
                                    $query="SELECT * from rd_packages";
                                    ...
                                    while($row=mysqli_fetch_array($runquery)){
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" name="product[]" value="<?php echo $row['pid']; ?>" ></td>
                                ...
                                <div class="row">
                                    <div class="col-md-12" >
                                        <br>
                                        <input type="submit" class="btn btn-primary" style="float:right" name="donate" value="Submit">
                                    </div>
